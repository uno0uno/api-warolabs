...
def test_pending_allowlist_is_exact():
    ...
    assert is_pending_session_route_allowed("GET", "/onboarding/status")
    assert is_pending_session_route_allowed("GET", "/onboarding/payment-status")
    ...
    assert is_pending_session_route_allowed("GET", "/billing/lemon-squeezy/checkout-status")
    ...
    assert not is_pending_session_route_allowed("POST", "/onboarding/checkout")
    assert not is_pending_session_route_allowed("DELETE", "/billing/subscription")
    assert not is_pending_session_route_allowed("GET", "/billing/usage-history")
